...
public class StoryView {
    public static void epilogue() throws Exception {
        ...
        ConsoleEffectTest.slowPrint(pre,60);
        ...
        ConsoleEffectTest.slowPrint(pro,60);
    ...
    public static void stage1Start() throws Exception {
        ...
        ConsoleEffectTest.slowPrint(title, 60);
        ...
        ConsoleEffectTest.slowPrint(sb.toString(), 60);
        ...
        // 👉 슬라임 등장 텍스트
        System.out.println(ConsoleEffectTest.GREEN + "\n슬라임 등장!\n" + ConsoleEffectTest.RESET);
        Thread.sleep(500);
    ...
    public static void stage1End() throws Exception {
        ...
        ConsoleEffectTest.slowPrint(story,60);
    }
    ...
    public static void stage2Start() throws Exception {
     ...
     // 긴장감
        ...
        // 고블린 등장 텍스트
        System.out.println(ConsoleEffectTest.RED + "\n고블린 등장!\n" + ConsoleEffectTest.RESET);
        Thread.sleep(500);
