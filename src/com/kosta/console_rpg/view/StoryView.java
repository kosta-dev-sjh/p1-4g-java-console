...
public class StoryView {
    public static void epilogue() throws Exception {
        ...
        ConsoleEffectUtil.slowPrint(pre,60);
        ...
        ConsoleEffectUtil.slowPrint(pro,60);
    ...
    public static void stage1Start() throws Exception {
        ...
        ConsoleEffectUtil.slowPrint(title, 60);

        StringBuilder sb = new StringBuilder();

        sb.append("왕국 동쪽 끝 초록 들판은 이름과 달리 더 이상 평화롭지 않았다.\n\n");
        sb.append("반투명한 슬라임 무리가 들판을 뒤덮으며 꽃들을 녹여버리고 있었고, 마을 사람들은 두려움에 떨며 집 안에 숨어 있었다.\n\n");
        sb.append(String.format("[%s]은/는 초원 어귀에 서서 천천히 검을 뽑아 들었다.\n\n", heroName));
        sb.append("눈앞에 펼쳐진 들판 가득 번들거리는 슬라임들이 그를 향해 일제히 몸을 굴려오기 시작했다......\n");

        ConsoleEffectUtil.slowPrint(sb.toString(), 60);
    }
    ...
    public static void stage1End() throws Exception {
        ...
        sb.append(String.format("[%s]은/는 숨을 고르고 적을 관찰했다. \n\n",heroName));
    ...
    public static void stage2Start() throws Exception {
        ...
        sb.append(String.format("초원을 뒤로하고 북쪽 산맥으로 발걸음을 옮긴 [%s]은/는 어둠 속에서 타오르는 횃불 무리를 발견했다.\n\n", heroName));
        sb.append(String.format("고블린동굴 — 산의 내장처럼 깊이 파인 그 굴은 역겨운 냄새와 괴성으로 가득 차 있었다.\n\n"));
        sb.append(String.format("[%s]은/는 검손잡이를 단단히 쥐며 어둠 속으로 한 걸음씩 나아갔다.\n", heroName));
    ...
    public static void stage2End() throws Exception {
        ...
        sb.append(String.format("[%s]은/는 패닉하지 않았다. \n\n", heroName));
    ...
    public static void stage3Start() throws Exception {
        ...
        sb.append(String.format("[%s]은/는 드래곤레어 앞에 섰을 때, 외투는 너덜너덜했고 검에는 수십 번의 전투 흔적이 새겨져 있었다. \n\n", heroName));
        sb.append(String.format("굴 안에서 뜨거운 바람이 터져나왔다.\n\n"));
        sb.append(String.format("비늘 하나하나가 흑요석처럼 빛나는 드래곤 이그나르가 날개를 펼치자 하늘이 가려졌다.\n\n"));
        sb.append(String.format("그러나 [%s]은/는 뒷걸음치지 않았다. \n\n", heroName));
    ...
    public static void bossEntrance() throws Exception {
        ...
        System.out.println(ConsoleEffectUtil.RED + "\n거대한 존재가 모습을 드러낸다...\n" + ConsoleEffectUtil.RESET);
        Thread.sleep(700);
        
        System.out.println(ConsoleEffectUtil.YELLOW + "\n🔥 드래곤이 포효한다!!! 🔥\n" + ConsoleEffectUtil.RESET);
        Thread.sleep(700);
    }
    
    public static void bossWarning() throws Exception {
        for (int i = 0; i < 3; i++) {
            System.out.println(ConsoleEffectUtil.RED + "\n!!! WARNING !!!" + ConsoleEffectUtil.RESET);
            Thread.sleep(400);
            System.out.println();
            Thread.sleep(200);
        }
    ...
    public static void stage3End() throws Exception {
        ...
        sb.append(String.format("어깨에 상처가 나고 피가 흘렀지만 [%s]은/는 쓰러질 때마다 다시 일어섰다.\n\n", heroName));
        ...
        sb.append(String.format("[%s]은/는 검을 회수하고 조용히 걸어나왔다.\n", heroName));
    ...
    public static void end() throws Exception {
        ...
        sb.append(String.format("[%s]은/는 왕궁이 아닌 마을로 돌아갔다. \n\n", heroName));
